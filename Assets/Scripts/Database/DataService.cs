...
public class DataService
{
 ...
 Application.dataPath + "/StreamingAssets/" + DatabaseName;  // this is the path to your StreamingAssets in iOS
    ...
    {
        _connection.DropTable<Drone>();
        _connection.DropTable<DronePart>();
        _connection.DropTable<Error>();
        _connection.DropTable<Exam>();
        _connection.DropTable<Order>();
        _connection.DropTable<OrderHasProducts>();
    ...
    {
        _connection.CreateTable<Drone>();
        _connection.CreateTable<DronePart>();
        _connection.CreateTable<Error>();
        _connection.CreateTable<Exam>();
        _connection.CreateTable<Order>();
        _connection.CreateTable<OrderHasProducts>();
